 ...
 */
class VerwijderAccountForm extends FormBase {
  ...
  public function getFormId() {
    return 'account_verwijderen_form';
  }

  /**
   * Constructs a VerwijderAccountForm object.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $extra = NULL) {
    ...
    // Warning information for super user, that the account can not be delete
    if ($account->id() == 1) {
        $form['markup'] = [
          '#type' => 'markup',
          '#markup' => $this->t('Opgepast!Je bent superadmin en kan je account niet verwijderen'),
          '#prefix' => '<h2>',
          '#suffix' => '</h2>',
        ];
    }
